            ...
            <div class="tab-content" id="nav-tabContent" style="width: 950px;">
                            ...
                            <div class="col-sm-4" style="left: 10%">
                                <div class="panel panel-white no-radius text-center">
                                    <div class="panel-body">
                                        ...
                                        <h2 class="StepTitle" style="margin-top: 5%;">My Appointments</h2>
                        ...
                        <div class="col-sm-4" style="left: 20%;margin-top:5%">
                            <div class="panel panel-white no-radius text-center">
                                <div class="panel-body">
                                    ...
                                    <h2 class="StepTitle" style="margin-top: 5%;">Prescriptions</h2>
                ...
                <div class="tab-pane fade" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
                    <div class="container-fluid">
                        <div class="card">
                            <div class="card-body">
                                <div style="text-align: center;"><h4>Create an appointment</h4></div>
                                <br>
                ...
                <div class="tab-pane fade" id="app-hist" role="tabpanel" aria-labelledby="list-pat-list">
                    ...
                    <table class="table table-hover">
                        ...
                        $query = "select ID,doctor,docFees,appdate,apptime,userStatus,doctorStatus from appointmenttb where fname ='$fname' and lname='$lname' LIMIT " . $page_first_result . ',' . $result_per_page;
                        $result = mysqli_query($con, $query);
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            ...
                            for($p=1;$p<=$number_of_pages;$p++){
                                echo '<li '.(($p==$page)?'class="page-item active"':"page-item").'><a class="page-link" href="patient-panel.php?page=' . $p . '" '.(($p==$page)?'tabIndex="selected"':"").'>' . $p . '</a></li>';
                            }
                            ?>
                        </ul>
                    </nav>
                ...
                <div class="tab-pane fade" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list">
                    ...
                    <table class="table table-hover">
                        ...
                        $page_first_result = ($page-1)*$result_per_page;
                        $query = "select doctor,ID,appdate,apptime,disease,allergy,prescription from prestb where pid='$pid' LIMIT " . $page_first_result . ',' . $result_per_page;
                        $result = mysqli_query($con, $query);
                        if (!$result) {
                                    ...
                                    <form method="get">
                                        ...
                                        <a href="./patient-panel.php?php echo $row['ID']?>">
                                            ...
                                            <input type="submit" onclick="alert('Bill Paid Successfully');"
                                                   name="generate_bill" class="btn btn-success" value="View Bill"/>
                                        </a>
                                </td>
                                </form>
